"""IPPOEvaluator conducting multi-episode evaluations for multi-agent robot fleets."""
...
class IPPOEvaluator:
    """Evaluates multi-agent policy performance across evaluation episodes."""
    ...
    def evaluate(
        ...
        fairness = IPPOMetricsTracker.compute_jains_fairness(ep_rewards)
