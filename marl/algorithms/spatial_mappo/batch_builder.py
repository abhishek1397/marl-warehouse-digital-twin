"""SpatialMAPPOBatchBuilder building mini-batches for joint actor-critic updates in S-MAPPO."""
...
class SpatialMAPPOBatchBuilder:
    """Helper module constructing joint mini-batch tensors for Spatial MAPPO CTDE updates."""
