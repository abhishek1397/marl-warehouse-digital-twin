"""SpatialMAPPOAgent module encapsulating a decentralized robot actor policy, buffer, and optimizer for S-MAPPO."""
...
class SpatialMAPPOAgent:
    """Encapsulates a decentralized S-MAPPO robot actor policy and rollout storage."""

    def __init__(
        self,
        agent_id: str,
        policy: PolicyNetwork,
        config: SpatialMAPPOConfig,
    ) -> None:
        self.agent_id: str = agent_id
        self.config: SpatialMAPPOConfig = config
