"""SpatialMAPPOEvaluator conducting multi-episode evaluations for multi-robot fleets."""
...
class SpatialMAPPOEvaluator:
    """Evaluates Spatial MAPPO multi-agent fleet policy performance during decentralized execution."""
    ...
    def evaluate(
        ...
        fairness = SpatialMAPPOMetricsTracker.compute_jains_fairness(ep_rewards)
